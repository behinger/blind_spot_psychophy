...
```{r Read Data}
setwd('/net/store/nbp/projects/EEG/blind_spot/bs_svn/analysis/r-analysis/stan_2015/')
...
source('../plots_paper/bs_paper_main.r')
...
#load('../mcmc_stan_matrix_16_09_2015')
load('stan_with_between_22_09_2015')
#load('../stan_expAll_28_09_2015')
#load('../stan_expAll_allFac_28_09_2015')
#factorialFit = factorialFit.expAll
```
...
ggsave(filename="2016-03-15_-exp1.pdf",useDingbats=FALSE,width=5,height=4)
```
...
ggsave(filename="2016-03-15_normalized_data-splitExperiments.pdf",useDingbats=FALSE,width=6,height=3,scale=1.5)
```
